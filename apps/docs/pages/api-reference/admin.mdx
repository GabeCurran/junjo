...
No query parameters in V1: the chart is a snapshot, not a time-windowed analytic. The dashboard's page-level date-range picker is irrelevant to this endpoint.
