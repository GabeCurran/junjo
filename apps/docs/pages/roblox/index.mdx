...
| `junjo.groups:create / get / list / update / delete / restore` | shipped (Phase 8.2). |
| `junjo.groups` membership: `inviteByUserId / inviteByCode / inviteByLink / bulkInvite / acceptInvitation / declineInvitation / leave / kick` | shipped (Phase 8.2). |
| `junjo.groups` relationships: `setRelationship / clearRelationship / getRelationship / listRelationships` | shipped (Phase 8.2). |
| `junjo.groups` sub-groups: `setParent / listChildren` | shipped (Phase 8.2). |
| `junjo.members:get / getById / list / listForUser / setMetadata / setNotes / assignRole / removeRole / overridePermission / clearPermissionOverride / listPermissionOverrides` | shipped (Phase 8.2). |
| `junjo.roles:create / get / list / update / delete / grantPermission / revokePermission` | shipped (Phase 8.2). |
| `junjo.invitations:list / get / revoke` | shipped (Phase 8.2). |
| `junjo.audit:list` | shipped (Phase 8.2). |
| `junjo.webhooks.endpoints:create / list / update / delete` | shipped (Phase 8.2). |
| `junjo:can(userId, groupId, permission)` and `junjo:check(...)` | shipped (Phase 8.2). |
| `Junjo.RobloxUserIdAdapter(opts?)` | shipped (Phase 8.3). |
...
## Manual verification (Phase 8.1 + 8.2 + 8.3)
