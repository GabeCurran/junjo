...
| `CheckPermission` | `FOnJunjoPermissionCheck` | Full decision including its source (role, override, default, none). |
...
| `ListGroups` | `FOnJunjoGroupPage` | Cursor-paginated; feed `NextCursor` back through `Params.Cursor`. |
