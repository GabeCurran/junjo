...
- [`useMembers`](./use-members#optimistic-updates) - `applyOptimistic((prev: Member[]) => Member[])`
- [`useInvitations`](./use-invitations#optimistic-updates) - `applyOptimistic((prev: Invitation[]) => Invitation[])`
- [`useGroup`](./use-group#optimistic-updates) - `applyOptimistic((prev: { group, members }) => { group, members })`
