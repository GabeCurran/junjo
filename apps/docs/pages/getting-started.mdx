...
The default listen port is `8787`. Override with `PORT=...`. See [`packages/server/README.md`](https://github.com/gabe-curran/junjo/blob/main/packages/server/README.md) for the full env-var table.
