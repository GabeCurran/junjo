...
The methods listed as **shipped** are real implementations. Other methods (`assignRole`, `removeRole`, `overridePermission`, `clearPermissionOverride`, `listPermissionOverrides`) are stubbed and throw `not_implemented` until later phases.
