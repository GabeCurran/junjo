...
- [`PATCH /v1/groups/:id/members/:userId`](/api/groups) - the underlying HTTP route.
...
- [`POST /v1/groups/:id/members/:userId/permissions/:permission`](/api/groups) - the underlying HTTP route.
...
- [`DELETE /v1/groups/:id/members/:userId/permissions/:permission`](/api/groups) - the underlying HTTP route.
...
- [`GET /v1/groups/:id/members/:userId/permissions`](/api/groups) - the underlying HTTP route.
...
- [`POST /v1/groups/:id/members/:userId/roles/:roleId`](/api/groups) - the underlying HTTP route.
...
- [`DELETE /v1/groups/:id/members/:userId/roles/:roleId`](/api/groups) - the underlying HTTP route.
