...
`subscribe` still exists on the type surface today but throws `JunjoError("not_implemented")` until Phase 5.1 ships. The shape is stable; it will fill in without breaking changes.
