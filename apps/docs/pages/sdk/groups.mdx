...
- [`POST /v1/groups/:id/leave`](/api/groups) - the underlying HTTP route.
...
- [`POST /v1/groups/:id/members/:userId/kick`](/api/groups) - the underlying HTTP route.
...
- [`POST /v1/groups/:id/bulk-invite`](/api/groups) - the underlying HTTP route.
...
- [`PUT /v1/groups/:a/relationships/:b`](/api/groups) - the underlying HTTP route.
...
- [`DELETE /v1/groups/:a/relationships/:b`](/api/groups) - the underlying HTTP route.
...
- [`GET /v1/groups/:a/relationships/:b`](/api/groups) - the underlying HTTP route.
...
- [`GET /v1/groups/:a/relationships`](/api/groups) - the underlying HTTP route.
...
- [`PUT /v1/groups/:id/parent`](/api/groups) - the underlying HTTP route.
...
- [`GET /v1/groups/:id/children`](/api/groups) - the underlying HTTP route.
...
- **No replay across reconnects.** Events published while a subscriber is disconnected are lost. Use [`audit.list`](/api/audit) (Phase 5.2) or webhooks (Phase 5.3) for durable propagation.
...
- [`GET /v1/events/:groupId`](/api/events) - the underlying HTTP route.
