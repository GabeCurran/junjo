...
- [`POST /v1/groups/:id/roles`](/api/roles) - the underlying HTTP route.
...
- [`GET /v1/roles/:id`](/api/roles) - the underlying HTTP route.
...
- [`GET /v1/groups/:id/roles`](/api/roles) - the underlying HTTP route.
...
- [`PATCH /v1/roles/:id`](/api/roles) - the underlying HTTP route.
...
- [`DELETE /v1/roles/:id`](/api/roles) - the underlying HTTP route.
...
- [`POST /v1/roles/:id/permissions`](/api/roles) - the underlying HTTP route.
...
- [`DELETE /v1/roles/:id/permissions/:permission`](/api/roles) - the underlying HTTP route.
