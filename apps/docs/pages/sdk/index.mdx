...
| Namespace | Status |
|-----------|--------|
| [`junjo.groups`](/sdk/groups) | CRUD + invites + membership shipped through Phase 2.8; full Phase 4 (group relationships, sub-group `setParent` / `listChildren`) shipped. `subscribe` still stubbed pending Phase 5.1. |
