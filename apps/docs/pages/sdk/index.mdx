...
| Namespace | Status |
|-----------|--------|
| [`junjo.groups`](/sdk/groups) | CRUD + invites + membership shipped through Phase 2.8; `setRelationship` / `clearRelationship` / `getRelationship` / `listRelationships` shipped in Phase 4.1. `subscribe`, `setParent`, `listChildren` still stubbed. |
...
| `junjo.audit` | Stubbed; lands in Phase 5.2. |
| `junjo.webhooks` | Stubbed; lands in Phase 5.4 / 5.5. |
