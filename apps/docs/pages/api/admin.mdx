...
- Override semantics: an override (in either direction) wins over any role-derived grant during permission resolution (see `/api/permissions`). Setting an override does not touch role assignments.
