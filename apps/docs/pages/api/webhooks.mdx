...
This page documents the wire format, retry semantics, and signature scheme. The receiver-side helpers live in [`junjo.webhooks`](../sdk/webhooks); endpoint CRUD lands in Phase 5.5.
