...
1. In Discord, open the channel settings, go to **Integrations**, click **Create Webhook**, then **Copy Webhook URL**. Discord webhook URLs look like `https://discord.com/api/webhooks/<channel-id>/<token>`.
