...
The group-scoped routes (`GET /v1/groups/:id/members` and `GET /v1/groups/:id/members/:userId`) live on the [Groups](/api/groups) page; this page covers the routes mounted directly under `/v1/members` and `/v1/users/:userId/members`.
