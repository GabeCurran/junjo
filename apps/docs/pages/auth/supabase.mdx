...
The adapter wraps a Supabase client you construct yourself. The `@supabase/supabase-js` package is a peer dependency of `@junjo-io/sdk`, not a direct dependency: callers without Supabase pay no install cost.
...
import { supabaseAdapter } from "@junjo-io/sdk/adapters";
