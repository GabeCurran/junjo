...
describe.skipIf(!TEST_DATABASE_URL)(
  "GET /v1/admin/games/:gameId/analytics/group-churn (Phase 12.2a)",
  () => {
    ...
    it("counts a year-old departure when its group was created within the window (window applies to Group.createdAt)", async () => {
      // VISION: "for groups created in the date range, plot the
      // distribution of (member.left.createdAt - member.joined.createdAt)".
