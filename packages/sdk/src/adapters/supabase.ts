...
/**
 * Builds an AuthAdapter that verifies Supabase access tokens via
 * `client.auth.getUser(token)`. Returns null (rather than throwing) for
 * tokens that fail verification or lack the user id field.
 */
